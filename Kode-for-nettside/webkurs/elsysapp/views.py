...
def send_dictionary(request): 
    ...
    timedict = { "date" : [x[0]for x in objects.values_list("timestamp")]}
    ...
    timeJSON = dumps(timedict, default = myconverter)
...
def sanntid_first(request):
    ...
    return render(request, 'elsysapp/graphtest_first.html', {'xAcc': xAccJSON, 'yAcc': yAccJSON, 'zAcc':zAccJSON,'xVel': xVelJSON, 'yVel': yVelJSON, 'zVel':zVelJSON, 'timestamp':timeJSON, 'id':idJSON}) 
